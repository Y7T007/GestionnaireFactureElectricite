                    ...
                    <div class="card-body p-0">
                        <div class="row">
                            <div class="col-lg-6 d-none d-lg-flex">
                                <div class="flex-grow-1 bg-login-image" style="background-image: url(&quot;assets/img/dogs/image1.jpeg&quot;);"></div>
                            </div>
                            <div class="col-lg-6">
                                <div class="p-5">
                                    <div class="text-center">
                                        <h4 class="text-dark mb-4">Welcome Back Dear Client!</h4>
                                    </div>
                                    <?php
                                    session_start();
                                    ...
                                    <div class="text-center"><a class="small" href="login_admin.php">Are you an admin ?</a></div>
                                </div>
                            </div>
                        </div>
                    </div>
