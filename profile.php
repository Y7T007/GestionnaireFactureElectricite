...
$compteur = new Compteur($_SESSION['compteurID'], null, null, null);
$userInfo = $compteur->getCompteur($_SESSION['compteurID']);

// Update the user's information if the form is submitted
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    $compteur->updateCompteur($_POST['ClientName'], $_POST['Address'], $_POST['dateNaissance']);
        ...
        <nav class="navbar align-items-start sidebar sidebar-dark accordion bg-gradient-primary p-0 navbar-dark">
            <div class="container-fluid d-flex flex-column p-0"><a class="navbar-brand d-flex justify-content-center align-items-center sidebar-brand m-0" href="#">
                ...
                <ul class="navbar-nav text-light" id="accordionSidebar">
                    ...
                    <li class="nav-item"><a class="nav-link" href="table.html"><i class="fas fa-table"></i><span>Factures</span></a></li>
